...
| 二进制管理 Binary Management | yt-dlp 路径与可执行检查 Binary resolution/check（P0）：保证启动后可用，失败可提示。 | 🟢 **已完成 / Completed** |
| 二进制管理 Binary Management | ffmpeg 能力探测 ffmpeg capability probe（P1）：支持 remux/audio extract 场景。 | 🟢 **已完成 / Completed** |
